...
class PlayerManager:
	...
	def __init__(self, selected_player=None, excluded_player=[]):
		...
		self.manager.connect("name-appeared",
								lambda *args: self.on_player_appeared(*args))
		self.manager.connect("player-vanished",
								lambda *args: self.on_player_vanished(*args))
	...
	def show_most_important_player(self):
		...
		if current_player is not None:
			self.on_metadata_changed(current_player,
										current_player.props.metadata)
		else:
			self.clear_output()
